...
android {
    namespace = "app.nya.smsforward.client"
    ...
    defaultConfig {
        applicationId = "app.nya.smsforward.client"
    ...
    // such an APK must never be published (the release workflow refuses to run without the keystore).
